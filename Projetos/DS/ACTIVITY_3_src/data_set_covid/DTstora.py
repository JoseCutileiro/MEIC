...
data: DataFrame = read_csv("MEAN_IMPUTATION_OVER_SAMPLING_COVID.csv")
target = 'CovidPos'
...
file_tag = 'COVID'
train_filename = 'MEAN_IMPUTATION_OVER_SAMPLING_COVID.csv'
test_filename = 'MEAN_IMPUTATION_OVER_SAMPLING_COVID.csv'
target = 'CovidPos'
