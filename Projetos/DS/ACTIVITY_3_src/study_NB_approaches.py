...
target = "Credit_Score"
data = pd.read_csv("data/MEAN_IMPUTATION_credit_score.csv")
...
trn_data.to_csv("data/credit_score_train.csv", index=False)
tst_data.to_csv("data/credit_score_test.csv", index=False)
